...
class House_State_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'house_state';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'house-state' ), $i ),
...
// Initialize.
$house_state_footer_widgets = new House_State_Footer_Widgets();
